                ...
                <div className="flex h-full items-center justify-between gap-2 px-4 sm:px-6">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                        ...
                        <div className="relative" ref={profileDropdownRef}>
                            ...
                            {isProfileDropdownOpen && (
                                <div className="absolute right-0 top-12 w-64 rounded-lg border border-border bg-background shadow-lg overflow-hidden z-50 animate-fade-in">
                                    {/* User Info Header */}
                                    <div className="px-4 py-3 border-b border-border bg-muted/50">
                                        <div className="flex items-center gap-3">
                                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-muted border-2 border-border font-semibold text-sm">
                                                {user?.name
                                                    ?.charAt(0)
                                                    .toUpperCase() || "Y"}
                                            </div>
                                    ...
                                    <div className="border-t border-border">
                                        <button
                                            ...
                                            className="w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-accent transition-colors text-left text-destructive"
                                        >
