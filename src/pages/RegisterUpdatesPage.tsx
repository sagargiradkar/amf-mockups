      ...
      <div className="p-4 sm:p-6 md:p-8 max-w-3xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm sm:text-base text-muted-foreground">
            Get notified when new documentation, training content, or products are available.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 sm:p-8 shadow-sm">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start gap-2 text-xs text-muted-foreground">
              ...
              />
              <label htmlFor="agree">
                I agree to receive email communications about product news, documentation,
                and training. I can unsubscribe at any time.
              </label>
            </div>
            ...
            <Button
              ...
              disabled={submitting}
            >
              {submitting ? "Submitting..." : "Register for Updates"}
            </Button>
          </form>
        </div>
      </div>
