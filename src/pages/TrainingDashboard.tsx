					...
					>
						{cards.map((card) => (
							<button
								...
								className="group flex flex-col rounded-xl bg-white shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 w-full max-w-xs"
							>
								{/* Image */}
