...
export default function TrainingPage() {
	...
	const basicModules = mockTrainingModules.filter(
		(m) => m.type !== "premium"
	);
			...
			<div className="p-3 sm:p-4 md:p-6 max-w-7xl mx-auto">
				...
				<div className="mb-6 sm:mb-8 md:mb-10 text-center">
					...
					<p className="text-sm sm:text-base md:text-lg text-muted-foreground px-4">
						Enhance your team's expertise with comprehensive
						training programs
					</p>
				</div>
					...
					{premiumModule && (
						<div className="relative overflow-hidden rounded-xl border-2 border-destructive/20 bg-gradient-to-br from-destructive/5 via-destructive/10 to-destructive/5 p-5 sm:p-6 md:p-8 shadow-lg hover:shadow-xl transition-all">
							...
							<p className="mb-4 sm:mb-6 text-sm sm:text-base text-muted-foreground leading-relaxed">
								Interactive training modules and in-depth
								knowledge articles
							</p>
							...
							{!isRegistered && (
								<p className="mt-3 text-center text-[10px] sm:text-xs text-muted-foreground">
									Contact AMFtraining@amfbakery.com to
									register
								</p>
							)}
						</div>
									...
									>
										...
										<div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-between sm:justify-end">
											{module.isNew && (
												<Badge
													variant="new"
													className="font-bold text-[9px] sm:text-[10px] px-1.5 sm:px-2"
												>
													NEW
												</Badge>
											)}
					...
					<div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
						...
						<div className="flex-1">
							...
							<p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
								...
								for assistance with course registration and
								access.
							</p>
						</div>
					</div>
			...
			>
				<div className="space-y-4 sm:space-y-5">
					<p className="text-sm sm:text-base text-muted-foreground">
						AMF Method Premium Training features interactive
						training modules and in-depth knowledge articles.
					...
					<div className="rounded-lg border border-border bg-muted/50 p-4 sm:p-6">
						...
						<p className="text-xs sm:text-sm text-muted-foreground">
							Our training team will respond within 24 hours to
							schedule your demo.
						</p>
					</div>
